...
interface IPaymentMethods extends React.Props<any> {
...
const PaymentMethodsCore = (props: IPaymentMethods) => (
  <div>
    <div>
      <h3>Basic card</h3>
      <select style={{width: '300px'}} multiple={true}
    ...
    <div>
      ...
      <label>
      Android Pay
      <input type="checkbox" checked={props.supportedPaymentMethods.some((paymentMethod) =>
